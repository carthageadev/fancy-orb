// Shader sources stripped verbatim from the original AgentOrb bundle
// (chunk-222.js, module 870084 "AgentOrb"). Byte-for-byte copies of the
// original template literals — do not hand-edit; regenerate with the
// shaders/*.glsl files.
//
// Layout of the original module:
//   quadVert  -> the fullscreen quad vertex shader            ("a")
//   coreFrag  -> shared galaxy fragment library               ("r")
//   heroFrag  -> DUAL_LAYER program: quadVert + heroFrag      ("n")
//   batchFrag -> single-layer atlas program: instVert + batch("o")
//   instVert  -> instanced atlas vertex shader                ("s")
